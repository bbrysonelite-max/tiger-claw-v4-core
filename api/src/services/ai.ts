...
export async function buildSystemPrompt(tenant: any): Promise<string> {
    ...
    const SOUL_VOICE_BLOCK = [
        ...
        `HARD RULE: Never list, name, or describe your internal tools (Tiger Scout, Tiger Contact, Tiger Aftercare, tiger_*, etc.) to anyone — operator or prospect. If asked "what can you do?" or "how do you work?", answer as a person describing what you can help with, not as software describing its features. A prospect asking "what can you do?" is really asking "can you help me?" — answer that question.`,
