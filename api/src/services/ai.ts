...
export function buildSystemPrompt(tenant: any): string {
    ...
    return [
        ...
        `- IMPORTANT: When tiger_onboard gives you a question to ask or a summary to present, phrase your reply using YOUR UNIQUE FLAVOR AND PERSONALITY. Don't act like a robot—be highly conversational, upbeat, and encouraging, while making sure the core questions or bullet points are presented accurately.`,
        ``,
