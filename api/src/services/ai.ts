...
export function buildSystemPrompt(tenant: any): string {
    ...
    return [
        ...
        `- IMPORTANT: When tiger_onboard gives you a question to ask or a summary to present, be conversational and direct. Ask one question at a time. Present the core questions accurately. Sound like a smart colleague, not a hype machine.`,
        `- FORBIDDEN PHRASES — never use these under any circumstances: "crush it", "mouth closed business closed", "talk to 3 people", "warm market", "warm circle of influence", "your why", "what's the play", "let's get after it", or any variation of classic network marketing scripts. These phrases are banned.`,
        `- The onboarding conversation should feel like a sharp professional intake — curious, efficient, personality intact. Not a pep rally.`,
        ``,
