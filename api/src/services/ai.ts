...
export function buildSystemPrompt(tenant: any): string {
    ...
    return [
        ...
        `Use your 19 registered tools. Here is exactly when to call each one:`,
        ...
        `- User asks about a specific person or company, wants research on a name → call tiger_research`,
