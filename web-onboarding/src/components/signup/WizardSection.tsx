  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-white mb-2">Set Up Your Agent</h2>
  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      <div className="bg-zinc-900/60 border border-white/10 rounded-3xl p-8 sm:p-12 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3">Your agent is live.</h2>
...
// ---------------------------------------------------------------------------
// WizardSection — the long-scroll setup block
// ---------------------------------------------------------------------------

function WizardSectionInner() {
  ...
  // Auto-scroll the setup section into view when the user arrives with
  // ?email= (i.e. post-Stripe redirect). The hero is above; this pulls
  // them straight to the activation block.
  useEffect(() => {
...
export default function WizardSection() {
  return (
    <section id="setup" className="relative py-24 px-4 scroll-mt-16 border-t border-white/5">
